...
int main(int argc, char* argv[]) {
  ...
  @autoreleasepool {
    ...
    NSString* executable_name =
        [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleExecutable"];
    NSString* app_support_dir =
        [NSSearchPathForDirectoriesInDomains(NSApplicationSupportDirectory,
                                             NSUserDomainMask, YES) firstObject];
    NSString* cache_dir =
        [[app_support_dir stringByAppendingPathComponent:@"HailmaryCEF"]
            stringByAppendingPathComponent:executable_name ?: @"browser"];
    CefString(&settings.root_cache_path) = [cache_dir UTF8String];
    CefString(&settings.cache_path) = [cache_dir UTF8String];
