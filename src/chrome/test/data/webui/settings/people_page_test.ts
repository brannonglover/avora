...
suite('PeoplePageAccountSettings', function() {
  ...
  test('ShowCorrectRowsSignedIn', async function() {
    ...
    // Avora: the import row is gone -- chrome://settings/importData was
    // removed (see chrome/browser/resources/settings/route.ts).
    assertFalse(isChildVisible(peoplePage, '#importDataDialogTrigger'));
    // </if>
  });
