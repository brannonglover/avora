...
VerticalTabStripRegionView::VerticalTabStripRegionView(
  ...
  // Avora: horizontal swipe on the tab strip switches Spaces instead of
  // rotating focused tab groups.
...
void VerticalTabStripRegionView::OnTabStripViewSet() {
  ...
  // Avora: Provide the BrowserWindowInterface and per-window Space state to
  // the tab strip view so it can create Space-scoped Avora views.
  tab_strip_view()->SetBrowser(browser_view()->browser(),
                               browser_view()->GetWindowSpaceState());
