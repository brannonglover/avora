...
SettingsUI::SettingsUI(content::WebUI* web_ui)
  ...
  // Avora: no ImportDataHandler.  chrome://settings/importData is gone
  // (see chrome/browser/resources/settings/route.ts); upstream's importer
  // only ever finds Safari and Firefox on macOS anyway.  Avora's importer
  // is AvoraImportDialogView (chrome/browser/ui/views/avora/).
