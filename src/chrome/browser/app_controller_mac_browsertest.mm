...
// Avora: BookmarksMenuIsRestoredAfterProfileSwitch removed.  It exercised the
// per-profile caching of the main menu's Bookmarks submenu, and there is no
// such menu any more -- BuildBookmarksMenu is gone from main_menu_builder.mm,
// so -[AppController setLastProfile:] never constructs a BookmarkMenuBridge
// and -bookmarkMenuBridge always returns nullptr.
