...
// One icon in Avora's curated Lucide set.
struct SpaceIcon {
...
// The curated set, in picker order.  Defined in avora_space_icon_data.cc,
// which is generated by build-scripts/generate_space_icons.py.
